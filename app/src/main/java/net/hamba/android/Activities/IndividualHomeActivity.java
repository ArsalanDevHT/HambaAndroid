...
import net.hamba.android.Fragments.IndividualHomeFragment;
...
/*
        ...
        ft.replace(R.id.fragment, new IndividualHomeFragment());
        ft.commit();*/
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.individual_home, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            startActivity(new Intent(IndividualHomeActivity.this,ShopCustomerActivity.class));
            finish();
