...
public class CountryCodePicker extends RelativeLayout {
    private static String TAG = com.rilixtech.CountryCodePicker.class.getSimpleName();
    ...
    private CountryCodePicker.PhoneNumberWatcher mPhoneNumberWatcher;
    CountryCodePicker.PhoneNumberInputValidityListener mPhoneNumberInputValidityListener;
    ...
    private CircularImageView mImvFlag;
    ...
    private CountryCodePicker.OnCountryChangeListener mOnCountryChangeListener;
    ...
    private void init(AttributeSet attrs) {
        inflate(getContext(), R.layout.ccp_layout, this);

        mTvSelectedCountry = findViewById(com.rilixtech.R.id.selected_country_tv);
        mRlyHolder = findViewById(com.rilixtech.R.id.country_code_holder_rly);
        mImvArrow = findViewById(com.rilixtech.R.id.arrow_imv);
        mImvFlag = findViewById(com.rilixtech.R.id.flag_imv);
        mLlyFlagHolder = findViewById(com.rilixtech.R.id.flag_holder_lly);
        mRlyClickConsumer = findViewById(com.rilixtech.R.id.click_consumer_rly);
    ...
    private void applyCustomProperty(AttributeSet attrs) {
        ...
        TypedArray a = theme.obtainStyledAttributes(attrs, com.rilixtech.R.styleable.CountryCodePicker, 0, 0);

        try {
            mHidePhoneCode = a.getBoolean(com.rilixtech.R.styleable.CountryCodePicker_ccp_hidePhoneCode, false);
            mShowFullName = a.getBoolean(com.rilixtech.R.styleable.CountryCodePicker_ccp_showFullName, false);

            //hide nameCode. If someone wants only phone code to avoid name collision for same
            // country phone code.
            mHideNameCode = a.getBoolean(com.rilixtech.R.styleable.CountryCodePicker_ccp_hideNameCode, false);

            // show hint for phone number
            mIsHintEnabled = a.getBoolean(com.rilixtech.R.styleable.CountryCodePicker_ccp_enableHint, true);

            // enable auto formatter for phone number input
            mIsEnablePhoneNumberWatcher =
                    a.getBoolean(com.rilixtech.R.styleable.CountryCodePicker_ccp_enablePhoneAutoFormatter, true);

            setKeyboardAutoPopOnSearch(
                    a.getBoolean(com.rilixtech.R.styleable.CountryCodePicker_ccp_keyboardAutoPopOnSearch, true));

            mCustomMasterCountries = a.getString(com.rilixtech.R.styleable.CountryCodePicker_ccp_customMasterCountries);
            refreshCustomMasterList();

            mCountryPreference = a.getString(com.rilixtech.R.styleable.CountryCodePicker_ccp_countryPreference);
            refreshPreferredCountries();

            applyCustomPropertyOfDefaultCountryNameCode(a);

            showFlag(a.getBoolean(com.rilixtech.R.styleable.CountryCodePicker_ccp_showFlag, true));

            applyCustomPropertyOfColor(a);

            // text font
            String fontPath = a.getString(com.rilixtech.R.styleable.CountryCodePicker_ccp_textFont);
            if (fontPath != null && !fontPath.isEmpty()) setTypeFace(fontPath);

            //text size
            int textSize = a.getDimensionPixelSize(com.rilixtech.R.styleable.CountryCodePicker_ccp_textSize, 0);
            if (textSize > 0) {
            ...
            int arrowSize = a.getDimensionPixelSize(com.rilixtech.R.styleable.CountryCodePicker_ccp_arrowSize, 0);
            if (arrowSize > 0) setArrowSize(arrowSize);

            mSelectionDialogShowSearch =
                    a.getBoolean(com.rilixtech.R.styleable.CountryCodePicker_ccp_selectionDialogShowSearch, true);
            setClickable(a.getBoolean(com.rilixtech.R.styleable.CountryCodePicker_ccp_clickable, true));

            mSetCountryByTimeZone =
                    a.getBoolean(com.rilixtech.R.styleable.CountryCodePicker_ccp_setCountryByTimeZone, true);
            ...
            if (isInEditMode()) {
                mTvSelectedCountry.setText(
                        getContext().getString(com.rilixtech.R.string.phone_code,
                                getContext().getString(com.rilixtech.R.string.country_indonesia_number)));
            } else {
    ...
    private void applyCustomPropertyOfDefaultCountryNameCode(TypedArray tar) {
        //default country
        mDefaultCountryNameCode = tar.getString(com.rilixtech.R.styleable.CountryCodePicker_ccp_defaultNameCode);
    ...
    private void applyCustomPropertyOfColor(TypedArray typedArray) {
        ...
        if (isInEditMode()) {
            textColor =
                    typedArray.getColor(com.rilixtech.R.styleable.CountryCodePicker_ccp_textColor, DEFAULT_TEXT_COLOR);
        } else {
            textColor = typedArray.getColor(com.rilixtech.R.styleable.CountryCodePicker_ccp_textColor,
                    getColor(getContext(), com.rilixtech.R.color.defaultTextColor));
        }
        if (textColor != 0) setTextColor(textColor);

        mDialogTextColor =
                typedArray.getColor(com.rilixtech.R.styleable.CountryCodePicker_ccp_dialogTextColor, DEFAULT_TEXT_COLOR);

        // background color of view.
        mBackgroundColor =
                typedArray.getColor(com.rilixtech.R.styleable.CountryCodePicker_ccp_backgroundColor, Color.TRANSPARENT);
    ...
    protected void setSelectedCountry(Country selectedCountry) {
        ...
        if (mHideNameCode) {
            mTvSelectedCountry.setText(getContext().getString(com.rilixtech.R.string.phone_code, phoneCode));
        } else {
            if (mShowFullName) {
                ...
                if (mHidePhoneCode) {
                    ...
                    mTvSelectedCountry.setText(
                            getContext().getString(com.rilixtech.R.string.country_full_name_and_phone_code, countryName,
                                    phoneCode));
                }
            } else {
                ...
                if (mHidePhoneCode) {
                    ...
                    mTvSelectedCountry.setText(
                            getContext().getString(com.rilixtech.R.string.country_code_and_phone_code, iso, phoneCode));
                }
            }
        }
    ...
    @SuppressWarnings("unused") public void enablePhoneAutoFormatter(boolean isEnable) {
        ...
        if (isEnable) {
            if (mPhoneNumberWatcher == null) {
                mPhoneNumberWatcher = new CountryCodePicker.PhoneNumberWatcher(getSelectedCountryNameCode());
            }
        } else {
    ...
    @SuppressWarnings("unused") public String getDefaultCountryCodeWithPlus() {
        return getContext().getString(com.rilixtech.R.string.phone_code, getDefaultCountryCode());
    }
    ...
    public String getSelectedCountryCodeWithPlus() {
        return getContext().getString(com.rilixtech.R.string.phone_code, getSelectedCountryCode());
    }
    ...
    void setRegisteredPhoneNumberTextView(TextView phoneNumberTextView) {
        ...
        if (mIsEnablePhoneNumberWatcher) {
            if (mPhoneNumberWatcher == null) {
                mPhoneNumberWatcher = new CountryCodePicker.PhoneNumberWatcher(getDefaultCountryNameCode());
            }
    ...
    private void setPhoneNumberWatcherToTextView(TextView textView, String countryNameCode) {
        if (mIsEnablePhoneNumberWatcher) {
            if (mPhoneNumberWatcher == null) {
                mPhoneNumberWatcher = new CountryCodePicker.PhoneNumberWatcher(countryNameCode);
    ...
    public String getFullNumber() {
        ...
        if (mRegisteredPhoneNumberTextView == null) {
            Log.w(TAG, getContext().getString(com.rilixtech.R.string.error_unregister_carrier_number));
        } else {
    ...
    public String getFullNumberWithPlus() {
        return getContext().getString(com.rilixtech.R.string.phone_code, getFullNumber());
    }
     ...
     */
    public void setOnCountryChangeListener(CountryCodePicker.OnCountryChangeListener onCountryChangeListener) {
    ...
    @SuppressWarnings("unused") public void setHidePhoneCode(boolean hidePhoneCode) {
        ...
        // Reset the view
        if (mHideNameCode) {
            mTvSelectedCountry.setText(ctx.getString(com.rilixtech.R.string.phone_code, phoneCode));
            return;
        }
        ...
        if (mShowFullName) {
            ...
            if (mHidePhoneCode) {
                ...
                String country = ctx.getString(com.rilixtech.R.string.country_full_name_and_phone_code, name, phoneCode);
            ...
            if (mHidePhoneCode) {
                ...
                mTvSelectedCountry.setText(
                        ctx.getString(com.rilixtech.R.string.country_code_and_phone_code, iso, phoneCode));
            }
        }
    }
    ...
    public void setPhoneNumberInputValidityListener(CountryCodePicker.PhoneNumberInputValidityListener listener) {
    ...
    private void setEmptyDefault(String countryCode) {
        ...
        if (mIsEnablePhoneNumberWatcher && mPhoneNumberWatcher == null) {
            mPhoneNumberWatcher = new CountryCodePicker.PhoneNumberWatcher(countryCode);
        }
