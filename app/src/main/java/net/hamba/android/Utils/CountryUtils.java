...
public class CountryUtils {
     ...
     * or returns null if no country matches given code.
     */
    public static Country getByNameCodeFromAllCountries(Context context, String nameCode) {
    ...
    private static Map<String, List<String>> getTimeZoneAndCountryISOs(Context context) {
        ...
        // Read from raw
        InputStream inputStream = context.getResources().openRawResource(com.rilixtech.R.raw.zone1970);
