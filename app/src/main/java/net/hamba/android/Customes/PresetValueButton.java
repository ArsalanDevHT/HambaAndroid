...
public class PresetValueButton extends RelativeLayout implements RadioCheckable {
    ...
    private void parseAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            mValueTextColor = a.getColor(R.styleable.PresetValueButton_presetButtonValueTextColor, resources.getColor(R.color.colorWhite));
            mPressedTextColor = a.getColor(R.styleable.PresetValueButton_presetButtonPressedTextColor, resources.getColor(R.color.colorPrimary));
    ...
    public void setCheckedState() {
        setBackgroundResource(R.drawable.accent_btn);
